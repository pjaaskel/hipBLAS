...
mkdir build
cd build
cmake -DCMAKE_CXX_COMPILER=clang++ -DUSE_ONEAPI=ON -DCMAKE_C_COMPILER=clang -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-gdwarf-4" -DBUILD_CLIENTS_SAMPLES=ON  -DCMAKE_INSTALL_PREFIX=$PWD/packages ..
